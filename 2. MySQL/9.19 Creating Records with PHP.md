...
1. `creating-records.php` – Hardcoded insert.
2. `creating-records-2.php` – HTML form.
3. `creating-records-process.php` – Form data processor with DB insert.
...
<?php
// ✅ Create connection
$connection = mysqli_connect("localhost", "root", "root", "armour_db");
...
$query = "INSERT INTO student (name, age, gender, email, percentage)
          VALUES ('nitin', 21, 'M', 'ul@armour.com', 60)";
