...
* **`update-record-3.php`** – Auto-filled form using student `id` from URL, useful for edit pages.
...
<form action="update-records-process.php" method="POST">
    <p>
...
#### Run on Browser
```sql
http://192.168.94.145/php/update-records2.php
```
#### Output
```sql
Record updated successfully!
...
#### Run on Browser
```sql
http://192.168.94.145/php/update-record-3.php?id=1
```
#### Output
```sql
